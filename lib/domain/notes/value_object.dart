...
import 'package:flutter_to_do_ddd/domain/core/value_transformers.dart';
...
class NoteBody extends ValueObject<String> {
  ...
  factory NoteBody(String input) {
    return NoteBody._(validateMaxStringLength(input: input, maxLength: maxLength).flatMap(validateStringNotEmpty));
  }
...
class TodoName extends ValueObject<String> {
  ...
  factory TodoName(String input) {
    return TodoName._(validateMaxStringLength(input: input, maxLength: maxLength)
